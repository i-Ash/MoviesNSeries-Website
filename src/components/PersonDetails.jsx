...
const PersonDetails = () => {
    document.title = "MoviesNSeries | Person Details";
    ...
    return info ? (
        <div className="relative w-screen h-full px-5 sm:px-10 md:px-20 overflow-auto bg-[#1F1E24] ">
            {/* Part 1 navigation */}
            ...
            <div className="w-full flex ">
                ...
                <div className="w-[80%] ml-[5%]">
                    ...
                    <div className="list-disc text-zinc-400 w-full h-[50vh] mt-5 mb-10 overflow-x-hidden overflow-y-auto shadow-xl hover:shadow-[rgba(255,255,255,.2)] border-2 border-zinc-700 p-5">
